(function ($) {
    function MultiSelect($el, options) {
        ...
        this.$choice = $('<div class="ms-choice multiSelectSearch" data-id=' + $el.attr("id") + '><span class="placeholder">' +
                ...
                html.push(
					'<li' + (multiple ? ' class="multiple"' : '') + '>',
						'<label' + (disabled ? ' class="disabled"' : '') + '>',
							'<input type="' + (this.options.chooseOne ? "radio" : "checkbox") + '" name="selectItem" value="' + value + '"' +
                ...
                html.push(
					'<li class="group">',
						'<label class="optgroup' + (disabled ? ' disabled' : '') + '" data-group="' + _group + '">',
							'<input type="' + (this.options.chooseOne ? "radio" : "checkbox") + '" name="selectGroup"' + (disabled ? ' disabled="disabled"' : '') + ' /> ',
							label,
						'</label>',
					'</li>');
