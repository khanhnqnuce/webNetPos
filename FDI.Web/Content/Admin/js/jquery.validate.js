...
(function ($) {
    ...
    $.extend($.validator, {
        ...
        messages: {
            ...
            remote: "Giá trị đã tồn tại.",
            email: "Địa chỉ email chưa đúng.",
            url: "Liên kết chưa đúng.",
            date: "Bạn cần nhập dữ liệu ngày tháng năm.",
            dateISO: "Please enter a valid date (ISO).",
            number: "bận hãy nhập số.",
        ...
        prototype: {
            ...
            showLabel: function (element, message, imageLink) {
                ...
                if (label.length) {
                    ...
                    .attr("src", "/Content/Admin/Images/error.png").html("");
                    if (this.settings.wrapper) {
        ...
        methods: {
            ...
            date: function (value, element) {
                ...
                value = tempDate[1] + "/" + tempDate[0] + "/" + tempDate[2];
