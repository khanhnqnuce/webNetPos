    ...
    public class Excel
    {
        ...
        public static void ExportToTalCard(string filePath, ModelCardItem model)
        {
            ...
            using (var xlPackage = new ExcelPackage(newFile))
            {
                ...
                row++;
                var stt1 = 1;
                foreach (var item in model.LstCardItems)
                {
                    var col = 1;
        ...
        public static void BCDoanhThuBanThe(string filePath, List<EventItem> grid, ModelItem modelItem)
        {
            var newFile = new FileInfo(filePath);
            using (var xlPackage = new ExcelPackage(newFile))
            {
        ...
        public static void BCDoanhThuBanHang(string filePath, List<EventItem> grid, ModelItem modelItem)
        {
            var newFile = new FileInfo(filePath);
            using (var xlPackage = new ExcelPackage(newFile))
            {
