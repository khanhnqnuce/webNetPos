...
namespace NMBB.CTS.Base
{
    ...
    public partial class CTSEntities : DbContext
    {
        ...
        public DbSet<Document_DocumentFile> Document_DocumentFile { get; set; }
        ...
        public DbSet<MC_Action> MC_Action { get; set; }
        public DbSet<MC_ChucVu> MC_ChucVu { get; set; }
        public DbSet<MC_HoSo> MC_HoSo { get; set; }
        public DbSet<MC_HoSoFile> MC_HoSoFile { get; set; }
        public DbSet<MC_HoSoFileAttach> MC_HoSoFileAttach { get; set; }
        public DbSet<MC_HoSoLog> MC_HoSoLog { get; set; }
        public DbSet<MC_Process> MC_Process { get; set; }
        public DbSet<MC_QuyTrinh> MC_QuyTrinh { get; set; }
        public DbSet<MC_ThuPhi> MC_ThuPhi { get; set; }
        public DbSet<MC_ThuTuc> MC_ThuTuc { get; set; }
        public DbSet<MC_ThuTucFile> MC_ThuTucFile { get; set; }
        public DbSet<MenuGroup> MenuGroups { get; set; }
        public DbSet<Menu> Menus { get; set; }
        public DbSet<Module> Modules { get; set; }
        public DbSet<Module_Rating> Module_Rating { get; set; }
        ...
        public DbSet<SysModuleControl> SysModuleControls { get; set; }
        public DbSet<SysModuleSetting> SysModuleSettings { get; set; }
        ...
        public DbSet<TNEvent> TNEvents { get; set; }
        ...
        public virtual ObjectResult<Category_GetChildByParentId_Result> Category_GetChildByParentId(Nullable<int> parent, Nullable<int> type, string languageId, Nullable<bool> root)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Category_GetChildByParentId_Result>("Category_GetChildByParentId", parentParameter, typeParameter, languageIdParameter, rootParameter);
        }
    
        public virtual ObjectResult<Category_GetChildByParentIdOld_Result> Category_GetChildByParentIdOld(Nullable<int> parent, Nullable<int> type, string languageId, Nullable<bool> root)
        {
            var parentParameter = parent.HasValue ?
                new ObjectParameter("Parent", parent) :
                new ObjectParameter("Parent", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Category_GetChildByParentIdOld_Result>("Category_GetChildByParentIdOld", parentParameter, typeParameter, languageIdParameter, rootParameter);
        }
        ...
        public virtual ObjectResult<Department_GetChildByParentId_Result> Department_GetChildByParentId(Nullable<int> parentId, string languageId, Nullable<bool> root)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Department_GetChildByParentId_Result>("Department_GetChildByParentId", parentIdParameter, languageIdParameter, rootParameter);
        }
        ...
        [EdmFunction("CTSEntities", "fnSplit")]
        public virtual IQueryable<string> fnSplit(string sInputList, string sDelimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<string>("[CTSEntities].[fnSplit](@sInputList, @sDelimiter)", sInputListParameter, sDelimiterParameter);
        }
        ...
        public virtual ObjectResult<GetHoSoFilebyUser_Result> GetHoSoFilebyUser(Nullable<System.Guid> hosoId)
        {
            var hosoIdParameter = hosoId.HasValue ?
                new ObjectParameter("hosoId", hosoId) :
                new ObjectParameter("hosoId", typeof(System.Guid));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetHoSoFilebyUser_Result>("GetHoSoFilebyUser", hosoIdParameter);
        }
    
        public virtual ObjectResult<GetStatisticsVote_Result> GetStatisticsVote(string languageId)
        {
            var languageIdParameter = languageId != null ?
                new ObjectParameter("LanguageId", languageId) :
                new ObjectParameter("LanguageId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetStatisticsVote_Result>("GetStatisticsVote", languageIdParameter);
        }
        ...
        public virtual ObjectResult<ModuleControl_GetByPageID_Result> ModuleControl_GetByPageID(string slug, Nullable<int> pageID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ModuleControl_GetByPageID_Result>("ModuleControl_GetByPageID", slugParameter, pageIDParameter);
        }
    
        public virtual ObjectResult<ResultSearchDocument_Result> ResultSearchDocument(string categoryID, string keywords)
        {
            var categoryIDParameter = categoryID != null ?
                new ObjectParameter("CategoryID", categoryID) :
                new ObjectParameter("CategoryID", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ResultSearchDocument_Result>("ResultSearchDocument", categoryIDParameter, keywordsParameter);
        }
        ...
        public virtual ObjectResult<sp_GetGroupProcess_Result> sp_GetGroupProcess(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_GetGroupProcess_Result>("sp_GetGroupProcess", idParameter);
        }
        ...
        public virtual ObjectResult<sp_HoSoLogGetByMaHoSo_Result> sp_HoSoLogGetByMaHoSo(string maHoSo)
        {
            var maHoSoParameter = maHoSo != null ?
                new ObjectParameter("MaHoSo", maHoSo) :
                new ObjectParameter("MaHoSo", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_HoSoLogGetByMaHoSo_Result>("sp_HoSoLogGetByMaHoSo", maHoSoParameter);
        }
    
        public virtual ObjectResult<sp_MCHoSoGetByUserIdAndStep_Result> sp_MCHoSoGetByUserIdAndStep(string user, Nullable<int> step)
        {
            var userParameter = user != null ?
                new ObjectParameter("user", user) :
                new ObjectParameter("user", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_MCHoSoGetByUserIdAndStep_Result>("sp_MCHoSoGetByUserIdAndStep", userParameter, stepParameter);
        }
        ...
        public virtual ObjectResult<SysPage_GetChildByParent_Result> SysPage_GetChildByParent(Nullable<int> parent, Nullable<int> type, Nullable<int> id)
        {
            var parentParameter = parent.HasValue ?
                new ObjectParameter("Parent", parent) :
                new ObjectParameter("Parent", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SysPage_GetChildByParent_Result>("SysPage_GetChildByParent", parentParameter, typeParameter, idParameter);
        }
    
        public virtual ObjectResult<TNEvents_GetByDay_UserID_Result> TNEvents_GetByDay_UserID(Nullable<int> startDate, string userId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<TNEvents_GetByDay_UserID_Result>("TNEvents_GetByDay_UserID", startDateParameter, userIdParameter);
        }
    
        public virtual ObjectResult<TNEvents_GetStartEnd_UserID_Result> TNEvents_GetStartEnd_UserID(Nullable<int> startDate, Nullable<int> endDate, string userID)
        {
            var startDateParameter = startDate.HasValue ?
                new ObjectParameter("StartDate", startDate) :
                new ObjectParameter("StartDate", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<TNEvents_GetStartEnd_UserID_Result>("TNEvents_GetStartEnd_UserID", startDateParameter, endDateParameter, userIDParameter);
        }
    }
}
